...
def pytest_addoption(parser):
    parser.addoption(
        ...
        help=(
            ...
            "(e.g. kk_answer_03_permission_manager.py; any prefix works). "
...
def pytest_configure(config):
    ...
    # e.g. kk_answer_03_permission_manager.py → problem_03_permission_manager
    ...
    if not match:
        raise ValueError(
            ...
            f"Example: kk_answer_03_permission_manager.py (any prefix works)"
        )
